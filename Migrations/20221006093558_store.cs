    ...
    public partial class store : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SellerFname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SellerLname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SDOB = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SUsername = table.Column<string>(type: "nvarchar(max)", nullable: false),
